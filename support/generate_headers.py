...
def output_version_headers():
  ...
  with open(os.path.join(OutputFolder, 'okapi_version_auto.h'), 'w') as fp:
    fp.write("""
#ifndef _OKAPI_AUTO_VERSION_INFORMATION_H_
#define _OKAPI_AUTO_VERSION_INFORMATION_H_

#define OKAPI_BUILD_TAG        \"{0}\"
#define OKAPI_BUILD_CSET       \"{1}\"
#define OKAPI_BUILD_MAJOR      \"{2}\"
#define OKAPI_BUILD_MINOR      \"{3}\"
#define OKAPI_BUILD_RELEASE    \"{4}\"
#define OKAPI_BUILD_LOCAL_REV  \"{9}\"

#define OKAPI_BUILD_UNIQUEID   "{9}:" OKAPI_BUILD_CSET

#define OKAPI_VERSION_STRING   \"{5}\"
#define OKAPI_VERSION_FILE     {6},{7},{8},0

#endif /* _OKAPI_AUTO_VERSION_INFORMATION_H_ */
